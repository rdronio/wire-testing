...
const Navbar = () => {
  ...
  const handleToggleUserMenu = () => setToggleUserMenu(!toggleUserMenu);
          ...
          <div className="hidden md:block">
            <div className="ml-4 flex items-center md:ml-6">
              ...
              <div className="ml-3 relative">
                <div>
                  <button
                    className=" px-1 max-w-xs bg-gray-800 rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
                    id="user-menu"
                    aria-haspopup="true"
                ...
                {/* <!--
                  ...
                  --> */}
                <div className={toggleUserMenu ? '' : 'md:hidden lg:hidden'}>
                  <div
